...
model_path = root_dir + "models2/"
statistics_path = root_dir + "statistics2/"
figure_path = root_dir + "figures2/"
...
class PatternModel(nn.Module):
    def __init__(self):
        ...
        self.conv8 = nn.Conv2d(256, 256, 5, padding=2)
...
def experiments():
    lrs = [0.001, 0.0005] #[0.005, 0.001, 0.0005]
